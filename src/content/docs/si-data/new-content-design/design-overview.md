...
| # | 분류명 | 필드명 | 타입 | 용어 목록 |
|---|--------|--------|------|-----------|
| 1 | 주제분류 | `field_category_data` | Taxonomy (category_subject) | [용어 목록](../taxonomy/topic-classification/) |
| 2 | 시기분류 | `field_series` | Taxonomy (category_period) | [용어 목록](../taxonomy/period-classification/) |
| 3 | 형태분류 | `field_format` | Taxonomy (category_format) | [용어 목록](../taxonomy/format-classification/) |
...
2. **분류 택소노미 용어 정리**
   ...
   - 관련 문서: [주제분류](../taxonomy/topic-classification/), [형태분류](../taxonomy/format-classification/)
