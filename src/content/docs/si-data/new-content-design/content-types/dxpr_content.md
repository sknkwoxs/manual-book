...
기존 CMS의 `drag_and_drop_page` 콘텐츠 타입에 **8개 공통요소 필드를 추가**합니다. DXPR 빌더 기반 콘텐츠를 위한 콘텐츠 타입입니다.
...
| 2.0 | 2026-03-09 | 정책 변경 반영 — 머신명 `dxpr_content` → `drag_and_drop_page` (기존 CMS 유지), 공통요소 참조 링크 변경 |
