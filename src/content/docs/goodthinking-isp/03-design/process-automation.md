...
|------|--------|----------|
| 2026-02-23 | - | 초안 작성 |
| 2026-03-03 | ISP 컨설턴트 | 팀별 자동화 대상 매핑 추가 (4개 팀, 24단계), AS-IS→TO-BE 전환 매핑 보강 (결제확인/매출정산/알림 추가), 현행 DB 로직 기반 자동화 전환 매핑 14건 (SP/Trigger/Function → API/이벤트), 트리거 기반 자동화 관련 현행 객체 연결, KPI 추정값 채움 (인터뷰 후 실측 대체 필요), 자동화 우선순위 7건 추가 |
