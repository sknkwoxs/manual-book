...
| `business-analysis.md` | \~350 | 85% | 4/5 | 수작업 12건 식별 (유형별 분류: 시스템간 이관 4건, 외부 채널 4건, 수동 검증 3건, 물류 1건), 병목 7건 (영향도 매트릭스), 일일 수작업 6.5\~9시간 추정, 자동화 75\~80% 절감 기대. **워크 쉐도잉 미수행, 인터뷰 후 정량 확정 필요** |
