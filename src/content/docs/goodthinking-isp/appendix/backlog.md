...
| P2-05 | 사용자 인터뷰 (정기구독팀) | 완료 | 높음 | interview.md | 2026-03-17 수행 |
| P2-06 | 사용자 인터뷰 (경영지원팀) | 완료 | 높음 | interview.md | 2026-03-19 수행 |
| P2-07 | 사용자 인터뷰 (영업팀) | 완료 | 높음 | interview.md | 2026-04-02 수행 |
| P2-08 | 사용자 인터뷰 (편집실) | 완료 | 중간 | interview.md | 2026-03-12 수행 |
...
### Phase 4: 구현계획 및 RFP (Week 7-8) — 2026-04-13 \~ 2026-04-30
...
| `schedule.md` | 245 | 85% | 5/5 | 8주 일정 상세, 역할별 주간 과업 명시. 담당자명 공란만 채우면 됨 |
...
> 실무자 인터뷰 수행 보조, 현장 조사 데이터 정리, 분석·설계 산출물 작성 지원, 보고서 편집·교정

| 우선순위 | 지원 대상 | 주요 작업 | 예상 소요 |
|:--------:|----------|----------|:---------:|
| **1** | `interview.md` / `meeting-notes/` | 인터뷰 동석·기록, 녹취 정리, 회의록 작성 | 지속 |
| **2** | `business-analysis.md` | 현장 관찰 데이터 구조화, 수작업·병목 목록 데이터 입력 | 1주 |
| **3** | `requirements.md` | 요구사항 추적 매트릭스 관리, 요구사항 목록 데이터 정리 | 3일 |
| **4** | 분석·설계 산출물 전체 | 산출물 서식 통일, 용어·수치 교차 검증, 오탈자 교정 | 지속 |
| **5** | `rfp-preparation.md` / 최종보고(PPT) | RFP 편집·교정, 최종보고 자료 디자인 보조, 납품본 패키징 | 1주 |
...
graph TD
    subgraph W12["Week 1-2 · Phase 1: 착수"]
        ...
        W12R["연구원<br/>킥오프 회의록 작성<br/>AS-IS 자료 정리"]
    ...
    subgraph W34["Week 3-4 · Phase 2: 현행 분석 ← 가장 바쁜 기간"]
        ...
        W34R["연구원<br/>인터뷰 동석·기록<br/>현장 데이터 정리"]
    ...
    subgraph W56["Week 5-6 · Phase 3: TO-BE 설계"]
        ...
        W56R["연구원<br/>산출물 작성 보조<br/>추적 매트릭스 관리"]
    ...
    subgraph W78["Week 7-8 · Phase 4: RFP"]
        ...
        W78R["연구원<br/>RFP 편집·교정<br/>최종 납품본 패키징"]
