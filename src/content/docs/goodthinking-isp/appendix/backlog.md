...
| `as-is-to-be.md` | \~210 | 85% | ★★★★★ | AS-IS 아키텍처 상세화, 인프라 IP/OS/WAS 반영, 외부 연동 7종, 웹연동 로그 발견사항 반영. **AS-IS 상세 수치(처리시간)가 일부 비어있음** |
...
| `system-diagnosis.md` | 566 | 90% | ★★★★★ | 매뉴얼 V2.4/V1.1 기반 전면 개편: 인프라 상세(IP/OS/WAS/DB), 86개 화면 분석, 추정 ERD(10 엔티티), 결제4종/선수수익 연동/로그 구조, 외부연동 7종, 시스템 문제점 구체화(MySQL→MSSQL 수정), TO-BE 구체 수치. **VPN 접근 후 실물 검증 필요** |
