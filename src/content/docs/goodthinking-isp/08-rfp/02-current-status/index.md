...
본 장은 (주)좋은생각의 현행 시스템·업무 현황과 본 사업에서 충족해야 할 비기능 요구사항(14건), 데이터 이관 요구사항, 외부 시스템 연동 요구사항을 정의함. 기능 요구사항의 상세는 제4장 4.3.2 SRE에 기재함.
...
나. 기능은 10개 도메인(대시보드 5, 고객 8, 구독 11, 주문 3, 배송 8, 결제·정산 16, CS 상담 10, 선물 4, 재고/도서 3, 시스템 7)으로 구성되며, 각 요구사항은 SRE-001 ~ SRE-075의 고유번호를 부여함.
