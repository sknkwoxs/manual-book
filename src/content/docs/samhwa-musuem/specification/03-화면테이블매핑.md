...
# SP100주년 뮤지엄 사이트 화면-테이블 매핑

> **버전**: 1.0 (간소화)  
> **작성일**: 2026-04-20  
> **특징**: 프론트엔드 기반 WordPress 프로젝트

---

## 1. 매핑 개요

뮤지엄 사이트의 각 화면(페이지)이 어떤 데이터베이스 테이블에서 데이터를 조회하는지 정리합니다.
